...
type SrcOValue_Generic = readonly PickWrapper<OSignal, any>[]

type InferO<Src> = (Src extends PickWrapper_Success
...
export type SignalMergePick_OValue<Src extends SrcOValue_Generic> = {
    -readonly [K in keyof Src]: InferO<Src[K]>
}

type SrcIValue_Generic = readonly PickWrapper<Signal, any>[]

type InferI<Src> = (Src extends PickWrapper_Success
    ? Signal_InferI<Src["value"]>
    : never
)

export type SignalMergePick_IValue<Src extends SrcIValue_Generic> = {
